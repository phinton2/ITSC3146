...
int count;
pthread_mutex_t the_mutex;  // Pthread mutex variable - initialize here if using the initializer macro
...
void* myFunction(void* arg)
{
    ...
    for (unsigned int i = 0; i < 10; ++i) {
        // TODO: Use a Pthread mutex to control access to the critical region.
        ...
        // TODO: Relinquish access to the Pthread mutex since the critical region is complete.
...
int main()
{
    ...
    // TODO: Destroy the pthread mutex if it was initialized.
