...
int count;
int turn;                        // Shared variable, indicates whose turn it is to execute
...
void enter_region(int thread_id)
{
    ...
    // TODO: Add the code to indicate the thread's interest in executing.
...
{
    // TODO: Add the code to set the flag indicating that the thread has exited the critical region.
...
void* myFunction(void* arg)
{
    ...
    for (unsigned int i = 0; i < 10; ++i) {
        // TODO: Make sure that the thread waits for its turn before it enters the critical region.
        ...
        // TODO: Make sure that the other thread gets a turn
